...
robot.model     = 1;        % Model of robotic manipulator (See details bellow)
...
% Two-segment planar robotic manipulator
    ...
    robot.DH_table = [      % DH table: d, a, alpha
        0 1 0
        0 1 0];             
    robot.offsets = [0; 0]; % Offsets of angle theta   
...
% Twelve-segment planar robotic manipulator
...
function InitObs_2113()
    obstacles.loc = [1.5 0.7 0 0.4; -1.5 -0.7 0 0.4; -1.5 0.7 0 0.4; -0.6 1.5 0 0.4;]';
    robot.q_init = [-2;-2.5]; 
    robot.q_goal = [2; 2.5];
end
...
function InitObs_2122()
    obstacles.loc = [0.5 0.5 0 1 1 0; 0.5 -1 0 1 -0.5 0]'; 
    robot.q_init = [-2;-2.5]; 
    robot.q_goal = [2; 2.5];
end
